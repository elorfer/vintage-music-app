  ...
  public transformUserData(user: User): any {
    return {
      ...
      artist: user.artist ? {
        ...
        bio: user.artist.bio,
        profile_image_url: user.artist.profileImageUrl,
        cover_image_url: user.artist.coverImageUrl,
        genres: user.artist.genres,
        followers_count: user.artist.followersCount,
        plays_count: user.artist.playsCount,
        is_verified: user.artist.isVerified,
